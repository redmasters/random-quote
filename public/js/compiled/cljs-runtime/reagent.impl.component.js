...
if((i < len)){
var k = (ks[i]);
var G__38385 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__38386 = (i + (1));
m = G__38385;
i = G__38386;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38294 = c;
var G__38294__$1 = (((G__38294 == null))?null:G__38294.prototype);
if((G__38294__$1 == null)){
return null;
} else {
return (G__38294__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__38295 = c;
var G__38295__$1 = (((G__38295 == null))?null:G__38295.prototype);
if((G__38295__$1 == null)){
return null;
} else {
return (G__38295__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__38388__delegate = function (args){
var G__38305 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__38305) : reagent.impl.component.as_element.call(null,G__38305));
};
var G__38388 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38389__i = 0, G__38389__a = new Array(arguments.length -  0);
while (G__38389__i < G__38389__a.length) {G__38389__a[G__38389__i] = arguments[G__38389__i + 0]; ++G__38389__i;}
  args = new cljs.core.IndexedSeq(G__38389__a,0,null);
} 
return G__38388__delegate.call(this,args);};
G__38388.cljs$lang$maxFixedArity = 0;
G__38388.cljs$lang$applyTo = (function (arglist__38390){
var args = cljs.core.seq(arglist__38390);
return G__38388__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__38307 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__38308 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__38308);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__38307);
}});
...
var c = this;
var G__38373_38395 = (c["cljsRatom"]);
if((G__38373_38395 == null)){
} else {
reagent.ratom.dispose_BANG_(G__38373_38395);
}
...
var renders_38396 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_38397 = cljs.core.first(cljs.core.vals(renders_38396));
if((cljs.core.count(renders_38396) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_38396))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_38397)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_38397], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__38374 = name;
switch (G__38374) {
case "":
...
var name = (function (){var G__38376 = fiber;
var G__38376__$1 = (((G__38376 == null))?null:(G__38376["type"]));
if((G__38376__$1 == null)){
return null;
} else {
return (G__38376__$1["displayName"]);
}
})();
var parent = (function (){var G__38377 = fiber;
if((G__38377 == null)){
return null;
} else {
return (G__38377["return"]);
}
})();
var path = (function (){var G__38378 = parent;
var G__38378__$1 = (((G__38378 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__38378) : reagent.impl.component.fiber_component_path.call(null,G__38378)));
if((G__38378__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38378__$1)," > "].join('');
}
})();
...
var temp__5751__auto__ = (function (){var G__38379 = c;
if((G__38379 == null)){
return null;
} else {
return (G__38379["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__38380 = (function (){var or__4212__auto__ = (function (){var G__38381 = c;
if((G__38381 == null)){
return null;
} else {
return (G__38381["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
return (G__38380["_currentElement"]);
}
})();
var name = (function (){var G__38382 = elem;
var G__38382__$1 = (((G__38382 == null))?null:(G__38382["type"]));
if((G__38382__$1 == null)){
return null;
} else {
return (G__38382__$1["displayName"]);
}
})();
var path = (function (){var G__38383 = elem;
var G__38383__$1 = (((G__38383 == null))?null:(G__38383["_owner"]));
var G__38383__$2 = (((G__38383__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__38383__$1) : reagent.impl.component.component_path.call(null,G__38383__$1)));
if((G__38383__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38383__$2)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__38384 = c;
var G__38384__$1 = (((G__38384 == null))?null:G__38384.constructor);
if((G__38384__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__38384__$1);
}
}
})();
