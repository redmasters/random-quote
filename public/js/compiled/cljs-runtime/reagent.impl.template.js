...
var G__38393 = o;
(G__38393[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__38434__i < G__38434__a.length) {G__38434__a[G__38434__i] = arguments[G__38434__i + 0]; ++G__38434__i;}
  args = new cljs.core.IndexedSeq(G__38434__a,0,null);
} 
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__38399){
var map__38400 = p__38399;
var map__38400__$1 = cljs.core.__destructure_map(map__38400);
var props = map__38400__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38400__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__38401){
var map__38402 = p__38401;
var map__38402__$1 = cljs.core.__destructure_map(map__38402);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38402__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__38406){
var map__38407 = p__38406;
var map__38407__$1 = cljs.core.__destructure_map(map__38407);
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38407__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38407__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__38408 = jsprops;
(G__38408["defaultValue"] = value);

(G__38408["onChange"] = (function (p1__38403_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__38403_SHARP_);
}));
...
var vec__38410 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38410,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38410,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38410,(2),null);
...
var jsprops = ({"argv": v});
var temp__5757__auto___38442 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___38442 == null)){
} else {
var key_38444 = temp__5757__auto___38442;
(jsprops["key"] = key_38444);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__38416){
var map__38417 = p__38416;
var map__38417__$1 = cljs.core.__destructure_map(map__38417);
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38417__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__38418 = reagent.impl.template.__GT_NativeWrapper();
(G__38418["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__38419 = wrapped;
(G__38419["syntheticInput"] = true);

return G__38419;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__38420 = wrapped__$1;
(G__38420["syntheticOnChange"] = on_change);

return G__38420;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__38421 = wrapped__$2;
(G__38421["syntheticOnUpdate"] = on_update);
...
var len__4818__auto___38448 = arguments.length;
var i__4819__auto___38449 = (0);
while(true){
if((i__4819__auto___38449 < len__4818__auto___38448)){
args__4824__auto__.push((arguments[i__4819__auto___38449]));

var G__38450 = (i__4819__auto___38449 + (1));
i__4819__auto___38449 = G__38450;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38425){
var G__38426 = cljs.core.first(seq38425);
var seq38425__$1 = cljs.core.next(seq38425);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38426,seq38425__$1);
}));
...
break;
default:
var G__38456 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__38456;
continue;
...
var n__4695__auto___38457 = a.length;
var i_38458 = (0);
while(true){
if((i_38458 < n__4695__auto___38457)){
(a[i_38458] = reagent.impl.template.as_element((a[i_38458])));

var G__38459 = (i_38458 + (1));
i_38458 = G__38459;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4695__auto___38460 = a.length;
var i_38461 = (0);
while(true){
if((i_38461 < n__4695__auto___38460)){
var val_38462 = (a[i_38461]);
if(((cljs.core.vector_QMARK_(val_38462)) && ((reagent.impl.template.key_from_vec(val_38462) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_38461] = reagent.impl.template.as_element(val_38462));

var G__38463 = (i_38461 + (1));
i_38461 = G__38463;
continue;
} else {
}
...
var ctx = ({});
var vec__38429 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38429,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38429,(1),null);
...
var G__38432 = (cljs.core.count(argv) - first_child);
switch (G__38432) {
case (0):
