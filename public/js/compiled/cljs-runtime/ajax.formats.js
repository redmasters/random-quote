...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__32673){
var map__32674 = p__32673;
var map__32674__$1 = cljs.core.__destructure_map(map__32674);
var request = map__32674__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32674__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__32679 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__32679.cljs$core$IFn$_invoke$arity$1 ? fexpr__32679.cljs$core$IFn$_invoke$arity$1(response) : fexpr__32679.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__32680 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__32680.cljs$core$IFn$_invoke$arity$1 ? fexpr__32680.cljs$core$IFn$_invoke$arity$1(response) : fexpr__32680.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__32681){
var map__32682 = p__32681;
var map__32682__$1 = cljs.core.__destructure_map(map__32682);
var request = map__32682__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32682__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
