...
var len__4818__auto___30583 = arguments.length;
var i__4819__auto___30584 = (0);
while(true){
if((i__4819__auto___30584 < len__4818__auto___30583)){
args__4824__auto__.push((arguments[i__4819__auto___30584]));

var G__30586 = (i__4819__auto___30584 + (1));
i__4819__auto___30584 = G__30586;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30476){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30477,G__30478,seq30476__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30496_SHARP_){
return (!((cljs.core.meta(p1__30496_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30507__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30508){var _e__27986__auto__ = e30508;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e30510){var _e__27986__auto__ = e30510;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30515 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30516 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30516);

try{var map__30517 = opts;
var map__30517__$1 = cljs.core.__destructure_map(map__30517);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30517__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30515);
}});
...
var temp__5751__auto___30593 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___30593)){
var managed_print_level_30594 = temp__5751__auto___30593;
var _STAR_print_level_STAR__orig_val__30545_30595 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30546_30596 = managed_print_level_30594;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30546_30596);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30526_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30526_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30545_30595);
}} else {
job_fn();
}
