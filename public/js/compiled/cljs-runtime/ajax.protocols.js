...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_32436 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_32436(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_32437 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_32437(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_32438 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_32438(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_32439 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_32439(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_32476 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_32476(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_32477 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_32477(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_32478 = (function (this$,header){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_32478(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_32479 = (function (this$){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_32479(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_32480 = (function (this$,request){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_32480(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_32481 = (function (this$,response){
var x__4509__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_32481(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4463__auto__,k32422,else__4464__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32422,else__4464__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4484__auto__,p__32427){
var vec__32428 = p__32427;
var k__4485__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32428,(0),null);
var v__4486__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32428,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32421){
var self__ = this;
var G__32421__$1 = this;
return (new cljs.core.RecordIter((0),G__32421__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32423,other32424){
var self__ = this;
var this32423__$1 = this;
return (((!((other32424 == null)))) && ((((this32423__$1.constructor === other32424.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32423__$1.status,other32424.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32423__$1.body,other32424.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32423__$1.status_text,other32424.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32423__$1.headers,other32424.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32423__$1.was_aborted,other32424.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32423__$1.__extmap,other32424.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4468__auto__,k32422){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k32422);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4469__auto__,k__4470__auto__,G__32421){
var self__ = this;
var this__4469__auto____$1 = this;
var pred__32432 = cljs.core.keyword_identical_QMARK_;
var expr__32433 = k__4470__auto__;
if(cljs.core.truth_((pred__32432.cljs$core$IFn$_invoke$arity$2 ? pred__32432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__32433) : pred__32432.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__32433)))){
return (new ajax.protocols.Response(G__32421,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32432.cljs$core$IFn$_invoke$arity$2 ? pred__32432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__32433) : pred__32432.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__32433)))){
return (new ajax.protocols.Response(self__.status,G__32421,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32432.cljs$core$IFn$_invoke$arity$2 ? pred__32432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__32433) : pred__32432.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__32433)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__32421,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32432.cljs$core$IFn$_invoke$arity$2 ? pred__32432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__32433) : pred__32432.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__32433)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__32421,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__32432.cljs$core$IFn$_invoke$arity$2 ? pred__32432.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__32433) : pred__32432.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__32433)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__32421,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4470__auto__,G__32421),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4460__auto__,G__32421){
var self__ = this;
var this__4460__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__32421,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__32425){
var extmap__4501__auto__ = (function (){var G__32435 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32425,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__32425)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32435);
} else {
return G__32435;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__32425),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__32425),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__32425),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__32425),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__32425),null,cljs.core.not_empty(extmap__4501__auto__),null));
});
