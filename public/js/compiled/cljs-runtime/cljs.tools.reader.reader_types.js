...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30939 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30939(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30940 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30940(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30943 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30943(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30944 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30944(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30945 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30945(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30946 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30946(reader);
}
});
...
var G__30956 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__30957 = s.append(c);
c = G__30956;
s = G__30957;
continue;
}
