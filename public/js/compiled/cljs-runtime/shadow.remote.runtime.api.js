...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35567 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_35567(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_35568 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_35568(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_35570 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_35570(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_35572 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_35572(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35573 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_35573(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35575 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_35575(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__35563,callback){
var map__35564 = p__35563;
var map__35564__$1 = cljs.core.__destructure_map(map__35564);
var input = map__35564__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35564__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35564__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
